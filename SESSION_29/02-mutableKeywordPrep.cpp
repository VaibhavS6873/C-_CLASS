...
class Date
{
    ...
    public:
        ...
        int get_day()const //internally it is as int get_day(const Date* this) so you can not alter member of object in this function
        {      
            ...
            //(const_cast is internally managed by compiler)
